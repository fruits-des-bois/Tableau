...
st.markdown(
    ...
    /* =================================
       ...
       ============================== */
    .stApp {
        background-color: #FFFFFF !important; /* Bleu nuit profond */
...
def appliquer_theme_plotly(fig):
    fig.update_layout(
        paper_bgcolor="#FFFFFF",  # Fond extérieur du graphique (identique à la page)
        plot_bgcolor="#FFFFFF",   # Fond de la zone de traçage
